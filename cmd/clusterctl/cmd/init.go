...
func runInit() error {
	...
	ComponentsList, first, err := c.Init(io.kubeconfig, io.coreProvider, io.bootstrapProviders, io.infrastructureProviders, io.targetNamespace, io.watchingNamespace, io.force)
	if err != nil {
		return err
	}
